...
import EditPage from "./pages/EditPage"; //  importing EditPage from pages
import ProtectedRoute from "./components/ProtectedRoute"; //importing ProtectedRoute from components
function App() {
  return (
    <>
      <AppContextProvider>
